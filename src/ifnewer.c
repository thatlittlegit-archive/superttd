...
#pragma message("warning: Compiled on Windows, ifnewer is not Windows compatible! Using dummy main{return 0} function.")
...
int main(int argc, char* argv[]) {
	...
	if(argc == 1) {
		...
		return 2;
	        ...
	        int fd1 = open(argv[1], O_RDONLY); file_err(fd1);
		int fd2 = open(argv[2], O_RDONLY); file_err(fd2);
